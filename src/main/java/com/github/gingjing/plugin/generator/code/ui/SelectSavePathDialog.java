...
import com.github.gingjing.plugin.generator.code.constants.StrState;
...
import com.github.gingjing.plugin.generator.code.tool.ModuleUtils;
 ...
 */
public class SelectSavePathDialog extends JDialog {
    /**
     * 主面板
     */
     ...
     * 构造方法
     */
    public SelectSavePathDialog(Project project) {
        ...
        this.mode = cacheDataUtils.getCreateMode();
    ...
    private void onOK() {
        ...
        // 保存配置
        TableInfo tableInfo = getCurrentTableInfo();
    ...
    private TableInfo getCurrentTableInfo() {
        return mode.getTableInfoAndConfig(tableInfoService, cacheDataUtils);
    }
