package com.github.gingjing.plugin.generator.code.provider;
...
public class EasyCodeGlobalVariableProvider extends VtlGlobalVariableProvider {
    ...
    public Collection<VtlVariable> getGlobalVariables(@NotNull VtlFile file) {
        ...
        result.add(new VtlLightVariable("callback", file, "com.github.gingjing.plugin.generater.entity.Callback"));
        result.add(new VtlLightVariable("tool", file, "com.github.gingjing.plugin.generater.tool.GlobalTool"));
        result.add(new VtlLightVariable("time", file, "com.github.gingjing.plugin.generater.tool.TimeUtils"));
        result.add(new VtlLightVariable("tableInfo", file, "com.github.gingjing.plugin.generater.entity.TableInfo"));
        result.add(new VtlLightVariable("tableInfoList", file, "java.util.List<com.github.gingjing.plugin.generater.entity.TableInfo>"));
        result.add(new VtlLightVariable("generateService", file, "com.github.gingjing.plugin.generater.tool.ExtraCodeGenerateUtils"));
