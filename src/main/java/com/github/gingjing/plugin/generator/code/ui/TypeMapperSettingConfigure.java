...
import com.github.gingjing.plugin.generator.code.entity.TypeMapperModel;
 ...
 */
public class TypeMapperSettingConfigure implements Configurable {
    /**
     * 主面板
     */
    ...
    public TypeMapperSettingConfigure(CodeFlutterGenCodeConfigComponent settings) {
        ...
        deleteButton.addActionListener(e -> {
            if (MessageDialogBuilder.yesNo(MsgValue.TITLE_INFO, "Confirm Delete Group " + typeMapperComboBox.getSelectedItem() + "?").isYes()) {
                if (CodeFlutterGenCodeConfigComponent.DEFAULT_NAME.equals(currGroupName)) {
