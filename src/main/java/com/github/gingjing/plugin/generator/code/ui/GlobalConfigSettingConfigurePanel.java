...
import com.github.gingjing.plugin.generator.code.entity.GlobalConfig;
 ...
 */
public class GlobalConfigSettingConfigurePanel implements Configurable {
    /**
     * 全局配置描述信息，说明文档
     */
     ...
     * 默认构造方法
     */
    GlobalConfigSettingConfigurePanel() {
        // 项目对象
        ...
        this.baseItemSelectPanel = new BaseItemSelectPanel<GlobalConfig>(group.get(currGroupName).getElementList()) {
            ...
            protected void selectedItem(GlobalConfig item) {
                ...
                if (templateEditor == null) {
                    ...
                    templateEditor = new TemplateEditor(project, item.getName() + PluginFileConstants.VELOCITY_FILE, item.getValue(), GLOBAL_CONFIG_DESCRIPTION_INFO, velocityFileType);
                    // 代码修改回调
