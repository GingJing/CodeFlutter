...
import com.github.gingjing.plugin.gsonformat.common.FieldHelper;
import com.github.gingjing.plugin.gsonformat.common.PsiClassUtil;
import com.github.gingjing.plugin.gsonformat.common.Try;
...
import static com.github.gingjing.plugin.gsonformat.common.StringUtils.captureName;
...
public abstract class BaseProcessor {
    ...
    private static HashMap<ConvertLibrary, BaseProcessor> sProcessorMap = new HashMap<>();
    ...
    static BaseProcessor getProcessor(ConvertLibrary convertLibrary) {
    ...
    protected void createGetAndSetMethod(PsiElementFactory factory, PsiClass cls, FieldEntity field) {
        if (field.isGenerate()) {
            ...
            Try.run(new Try.TryListener() {
                ...
                @Override
                public void runAgain() {
                    cls.addBefore(factory.createCommentFromText("// FIXME generate failure  method  set and get " + captureName(finalFieldName), cls),
                            cls.getChildren()[0]);
