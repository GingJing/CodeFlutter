package com.github.gingjing.plugin.gsonformat.action;

import com.github.gingjing.plugin.gsonformat.entity.ClassEntity;
import com.github.gingjing.plugin.gsonformat.process.ClassProcessor;
import com.github.gingjing.plugin.gsonformat.process.IProcessor;
import com.github.gingjing.plugin.gsonformat.ui.Toast;
...
public class DataWriter {
    ...
    private WriteCommandAction.Builder writeBuilder;

    public DataWriter(PsiFile file, Project project, PsiClass cls) {
        this.writeBuilder = WriteCommandAction.writeCommandAction(project, file);
