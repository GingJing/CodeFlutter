package com.github.gingjing.plugin.gsonformat.config;
...
public class Config {
    ...
    private boolean isAutoHumpName;// 是否驼峰命名
    ...
    public void save() {
        ...
        PropertiesComponent.getInstance().setValue("fieldPrivateMode", String.valueOf(isFieldPrivateMode()));
        PropertiesComponent.getInstance().setValue("useSerializedName", String.valueOf(isUseSerializedName()));
        PropertiesComponent.getInstance().setValue("objectFromData", String.valueOf(objectFromData));
        PropertiesComponent.getInstance().setValue("objectFromData1", String.valueOf(objectFromData1));
        PropertiesComponent.getInstance().setValue("arrayFromData", String.valueOf(arrayFromData));
        PropertiesComponent.getInstance().setValue("arrayFromData1", String.valueOf(arrayFromData1));
        PropertiesComponent.getInstance().setValue("objectFromDataStr", String.valueOf(objectFromDataStr));
        PropertiesComponent.getInstance().setValue("objectFromDataStr1", String.valueOf(objectFromDataStr1));
        PropertiesComponent.getInstance().setValue("arrayFromData1Str", String.valueOf(arrayFromData1Str));
        PropertiesComponent.getInstance().setValue("suffixStr", String.valueOf(suffixStr));
        PropertiesComponent.getInstance().setValue("reuseEntity", String.valueOf(reuseEntity));
        PropertiesComponent.getInstance().setValue("isAutoHumpName", String.valueOf(isAutoHumpName));
        PropertiesComponent.getInstance().setValue("virgoMode", String.valueOf(virgoMode));
        PropertiesComponent.getInstance().setValue("filedNamePreFixStr", String.valueOf(filedNamePreFixStr));
        PropertiesComponent.getInstance().setValue("annotationStr", String.valueOf(annotationStr));
        PropertiesComponent.getInstance().setValue("errorCount", String.valueOf(errorCount));
        PropertiesComponent.getInstance().setValue("entityPackName", String.valueOf(entityPackName));
        PropertiesComponent.getInstance().setValue("useFieldNamePrefix", String.valueOf(useFieldNamePrefix));
        PropertiesComponent.getInstance().setValue("generateComments", String.valueOf(generateComments));
        PropertiesComponent.getInstance().setValue("splitGenerate", String.valueOf(splitGenerate));
    }
    ...
    public static Config getInstant() {
        ...
        if (config == null) {
            ...
            config.setAutoHumpName(PropertiesComponent.getInstance().getBoolean("isAutoHumpName", true));
    ...
    public boolean isAutoHumpName() {
        return isAutoHumpName;
    }

    public void setAutoHumpName(boolean autoHumpName) {
        isAutoHumpName = autoHumpName;
    }
