package com.github.gingjing.plugin.gsonformat;
...
import com.github.gingjing.plugin.gsonformat.common.Utils;
...
import com.github.gingjing.plugin.gsonformat.entity.DataType;
import com.github.gingjing.plugin.gsonformat.entity.FieldEntity;
import com.github.gingjing.plugin.gsonformat.entity.IterableFieldEntity;
import com.github.gingjing.plugin.gsonformat.ui.FieldsDialog;
...
public class ConvertBridge {
    ...
    private ClassEntity collectClassAttribute(PsiClass psiClass, boolean collectInnerClass) {
        ...
        declareClass.put(Objects.requireNonNull(psiClass.getQualifiedName()), innerClass);
        CheckUtil.getInstant().addDeclareClassName(Objects.requireNonNull(psiClass.getQualifiedName()));
    ...
    private String createSubClassName(String key, Object o) {
        ...
        if (o instanceof JSONObject) {
            ...
            for (String str : strings) {
                stringBuilder.append(StringUtils.captureName(str));
            }
