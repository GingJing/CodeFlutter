 ...
 * @version: 1.0
 */
public class PluginJsonUtil {
    private static final Logger LOGGER = Logger.getInstance(PluginJsonUtil.class);
    public static ObjectMapper objectMapper;
    private PluginJsonUtil() {}
    ...
    public static String formatByJackson (Object obj) throws JsonProcessingException {
        return objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(obj);

    }

    public static <T> String toJsonByJackson(T obj) throws JsonProcessingException {
    ...
    public static <T> T fromByJackson(String json, Class<T> tClass) throws IOException {
    ...
    public static <T> T fromByJackson(String json, TypeReference<T> tTypeReference) {
        if (StringUtils.isBlank(json)) {
            return null;
        }
        try {
    ...
    public static <T> T fromByGson(String json, Class<T> tClass) throws JsonSyntaxException {
