...
public class PluginStringUtil {
    ...
    public static String removeCrlf(String str) {
        ...
        return PluginStringUtil.join(PluginStringUtil.tokenizeToStringArray(str,"\t\n\r\f")," ");
    }
    ...
    public static String unescapeXml(String str) {
        ...
        for(String key : XML.keySet()) {
            ...
            str = PluginStringUtil.replace(str, "&"+key+";", value);
        }
        return str;
    }
    ...
    /**
     * 将所有单词第一个字母转为大写first_case->FirstCase
     *
     * @param sqlName
    ...
    public static String makeAllWordFirstLetterUpperCase(String sqlName) {
        String[] sqlNameArray = sqlName.toLowerCase().split("_");
        StringBuilder result = new StringBuilder();
        String preStr = "";
        for(int i = 0; i < sqlNameArray.length; i++) {
            if(preStr.length() == 1) {
                result.append(sqlNameArray[i]);
            }else {
                result.append(capitalize(sqlNameArray[i]));
            }
            preStr = sqlNameArray[i];
        }
    ...
    public static String toJavaClassName(String str) {
        return makeAllWordFirstLetterUpperCase(PluginStringUtil.toUnderscoreName(str));
    }
    ...
    public static boolean containsKeywords(String checkStr, String... keywords) {
        if (checkStr == null) {
            return false;
        }
        if (keywords == null) {
    ...
    public static boolean containsAllKeywords(String checkStr, String... keywords) {
        if (checkStr == null) {
            return false;
        }
        if (keywords == null) {
    ...
    public static boolean ifEqualsKeywords(String str,String... keywords) {
        if(str == null) {
            return false;
        }
        if(keywords == null) {
